...
export const CATEGORY_COLORS = {
    [CategoryType.PRODUCTIVITY]: 'cat-productivity',
    [CategoryType.SECURITY]: 'cat-security',
    [CategoryType.COMPLIANCE]: 'cat-compliance',
    [CategoryType.MANAGEMENT]: 'cat-management',
    [CategoryType.VOICE]: 'cat-voice',
    [CategoryType.WINDOWS]: 'cat-windows',
    [CategoryType.VIVA]: 'cat-viva',
};
